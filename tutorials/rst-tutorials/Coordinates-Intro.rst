...
This object we've just created has various useful ways of accessing the
...
separate strings for RA/Dec or a single string. You'll need to give
...
cutout service to make sure HCG 7 is in the SDSS footprint and has good
image quality.
...
.. parsed-literal::
    ...
    ('HCG7_SDSS_cutout.jpg', <http.client.HTTPMessage at 0x7f617fc1f4a8>)
...
against an academic paper or a website like
